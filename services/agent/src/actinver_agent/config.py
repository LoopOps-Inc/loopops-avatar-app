...
class VoiceSettings(BaseSettings):
    ...
    #: ``google`` uses Vertex/Google Cloud Speech + TTS; ``stub`` accepts
    #: dev-only text transcripts over the socket and synthesises silence.
    provider: Literal["google", "stub"] = "stub"
